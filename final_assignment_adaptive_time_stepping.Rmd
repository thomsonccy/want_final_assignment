...
analyt_real.state=init.state * exp(-time.sequence*alpha/A)
...
area_under_results_curve = AUC(result.time,result.state)
area_under_analytical_curve = AUC(time.sequence, analyt_real.state)

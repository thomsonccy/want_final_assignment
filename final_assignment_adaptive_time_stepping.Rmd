...
Make sure working directory is set to the folder "want_final_assignment"
```{R}
# This line outputs your current working directory
# It should show ".../want_final_assignment_group_12"
getwd()
```


Load custom functions in "reservoir_functions.R"
```{R}
